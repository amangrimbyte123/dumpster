        ...
        {!loading && !error && (
          <div className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {services.slice(0, 2).map((service, idx) => (
              <div
                key={service.id}
                className={`bg-gradient-to-br ${idx === 0 ? 'from-white to-primary/5 border-primary/10' : 'from-white to-secondary/5 border-secondary/10'} rounded-2xl p-8 shadow-xl border hover:shadow-2xl transition-all duration-300`}
              >
