  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-secondary/5 to-background">
      ...
      <div className="relative h-[400px]">
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="text-white max-w-2xl">
            <Link href={`/${category.slug}/${location.slug}`} className="inline-flex items-center text-white/90 hover:text-white mb-4 transition-colors">
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 mb-8 border border-primary/10">
              <div className="flex items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-text/70">({business.reviewCount} reviews)</span>
                </div>
              </div>

              <div className="prose max-w-none">
                <h2 className="text-2xl font-semibold mb-4 text-primary">About</h2>
                <p className="text-text/70">{business.description}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {Object.entries(business.hours).map(([day, hours]) => (
                  <div key={day} className="flex justify-between">
                    ...
                    <span className="text-text/70">{hours}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 mb-8 sticky top-8 border border-primary/10">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <a href={`tel:${business.contact.phone}`} className="ml-3 text-text/70 hover:text-primary transition-colors">
                    {business.contact.phone}
                  </a>
                </div>
                <div className="flex items-center">
                  <EnvelopeIcon className="h-6 w-6 text-secondary" />
                  <a href={`mailto:${business.contact.email}`} className="ml-3 text-text/70 hover:text-primary transition-colors">
                    {business.contact.email}
                  </a>
                </div>
                <div className="flex items-center">
                  <GlobeAltIcon className="h-6 w-6 text-secondary" />
                  <a href={business.contact.website} target="_blank" rel="noopener noreferrer" className="ml-3 text-text/70 hover:text-primary transition-colors">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex space-x-4">
                    {business.socialMedia.facebook && (
                      <a href={business.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="text-text/70 hover:text-primary transition-colors">
                    ...
                    {business.socialMedia.instagram && (
                      <a href={business.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="text-text/70 hover:text-primary transition-colors">
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {business.socialMedia.twitter && (
                      <a href={business.socialMedia.twitter} target="_blank" rel="noopener noreferrer" className="text-text/70 hover:text-primary transition-colors">
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Related Businesses */}
        <div className="mt-12">
          <h2 className="text-2xl font-semibold mb-6 text-primary">Related Businesses in {location.name}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedBusinesses.map((relatedBusiness) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-lg mb-2 text-primary">{relatedBusiness.name}</h3>
                  <p className="text-text/70 text-sm mb-3">{relatedBusiness.shortDescription}</p>
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-text/70">{relatedBusiness.reviewCount} reviews</span>
                  </div>
                </div>
              </Link>
            ))}
